...
E aqui está a catástrofe: **$\sqrt{2}$ não é uma fração**. Não existem inteiros $p$ e $q$ tais que $\sqrt2 = p/q$. A demonstração é curta e devastadora --- talvez a primeira prova por absurdo da história. Suponha que $\sqrt{2} = p/q$ com a fração já **irredutível**, isto é, com $p$ e $q$ inteiros sem nenhum fator primo comum. Então $p^2 = 2q^2$, logo $p^2$ é par, e portanto $p$ é par, digamos $p = 2k$. Substituindo, $4k^2 = 2q^2$, ou seja $q^2 = 2k^2$, e então $q$ também é par. Mas $p$ e $q$ ambos pares compartilham o fator $2$ --- o que contradiz a hipótese de que a fração era irredutível. Absurdo. Logo $\sqrt{2}$ não pode ser escrito como razão de inteiros.
...
A **Teoria dos Números** é, na sua origem, o ramo da matemática que estuda os números inteiros --- os objetos mais concretos e antigos que existem, aqueles que a criança conta nos dedos. Foi assim que Gauss a entendeu, ao chamá-la de *Aritmética Superior* e proclamá-la a rainha da matemática. Mas o conceito de Gauss evoluiu enormemente. A disciplina moderna transbordou o inteiro: hoje ela investiga os **números algébricos** (raízes de polinômios de coeficientes inteiros) e o corpo que formam, os **números transcendentes** como $\pi$ e $e$ (que não são raiz de polinômio algum), as **aproximações diofantinas** --- quão bem um irracional pode ser imitado por frações ---, os **números de Liouville**, primeiros exemplos explícitos de transcendentes, e ramos inteiros como a teoria analítica, a algébrica e a transcendente dos números. O objeto de estudo, que começou nos inteiros, expandiu-se para toda a hierarquia dos números reais e complexos, classificados por sua relação com a aritmética.

Seria de esperar que fosse o reino do número puro, livre de letras. O que ocorre nos grandes teoremas é quase o oposto: o enunciado continua sendo aritmético, mas a demonstração abandona rapidamente a manipulação direta de inteiros e passa a trabalhar com funções, curvas, espaços, simetrias, representações e operadores.
...
![Diagrama concêntrico das extensões de Cayley--Dickson, dos números reais aos sistemas hipercomplexos de dimensões sucessivamente duplicadas](/assets/img/posts/cayley-dickson-diagrama.jpeg)
_Diagrama das extensões obtidas pela construção de Cayley--Dickson, com duplicação sucessiva da dimensão._

...
Toda a dificuldade de 3D mora naquele termo. E o critério de **Beale–Kato–Majda** (1984) — de J. Thomas Beale, Tosio Kato (1917–1999) e Andrew Majda (1949–2021) — diz que ele é a *única* fonte possível de catástrofe: se $T^\*$ é o tempo máximo de existência de uma solução suave, então
...
Setenta anos de trabalho não fecharam essa lacuna, mas a mapearam com precisão. Eberhard Hopf (1902–1983) estendeu Leray a domínios limitados em 1951. Olga Ladyzhenskaya (1922–2004), Giovanni Prodi e James Serrin deram critérios de regularidade **condicional**: se a solução pertence a $L^p_t L^q_x$ com $\tfrac{2}{p}+\tfrac{3}{q}\le 1$, ela é suave. E Caffarelli, Kohn e Nirenberg provaram em **1982** que o conjunto singular de uma solução fraca adequada tem medida de Hausdorff parabólica unidimensional nula — se houver singularidades, formam um conjunto muito pequeno. Resultados condicionais ou parciais: nenhum decide a questão.

Em 2016, Terence Tao (n. 1975) deu o argumento que melhor explica por que nada disso basta. Ele construiu uma equação "Navier–Stokes com média" — que preserva a estrutura de escala e a identidade de energia, alterando apenas a forma precisa da não linearidade — e provou que **essa** equação explode em tempo finito. A conclusão é metodológica e dura: nenhuma demonstração de regularidade global que use apenas a energia e a estrutura de escala pode funcionar, porque existe um objeto que satisfaz ambas e explode. É a chamada *barreira de supercriticidade*.
...
Em **7 de setembro**, Levent Alpöge e Tristan Buckmaster tornaram público — e Terence Tao comentou no mesmo dia em seu blog — um resultado que, nas palavras dele, se constrói "sobre o trabalho prévio de Córdoba e Martínez-Zoroa": **blow-up em tempo finito com termo de forçamento suave** para as três equações modelo, IPM, Boussinesq 2D e Euler 3D incompressível. A estratégia é iterativa: adicionam-se repetidamente correções de alta frequência a uma solução forçada anterior, explorando instabilidades linearizadas em torno de um escoamento de fundo cuidadosamente desenhado, mantendo a força suave a cada passo. O trabalho foi verificado em Lean.
